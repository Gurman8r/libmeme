...
namespace ml::gui
{
	struct ML_NODISCARD form final
	{
		/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace ml::gui
{
	...
	// plot
	struct ML_NODISCARD plot final
	{
		/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
	...
	// plot controller
	struct ML_NODISCARD plot_controller final
	{
		/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace ml::gui
{
	struct ML_NODISCARD texture_preview final
	{
...
namespace ml::gui
{
	struct ML_NODISCARD console final
	{
		/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
