...
namespace ml
{
	...
	struct ML_GRAPHICS_API VAO final
	{
		uint32_t	m_handle{};
		uint32_t	m_mode	{};
	...
	struct ML_GRAPHICS_API VBO final
	{
		uint32_t	m_handle{};
		uint32_t	m_usage	{};
		void *		m_data	{};
	...
	// IBO
	struct ML_GRAPHICS_API IBO final
	{
		uint32_t	m_handle{};
		uint32_t	m_usage	{};
		uint32_t	m_type	{};
	...
	// FBO
	struct ML_GRAPHICS_API FBO final
	{
		uint32_t	m_handle			{};
		vec2i		m_size				{};
	...
	struct ML_GRAPHICS_API RBO final
	{
		uint32_t	m_handle{};
		vec2i		m_size	{};
		uint32_t	m_format{};
