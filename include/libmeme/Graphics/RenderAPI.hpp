...
namespace ml::gfx
{
	...
	public:
		...
		ML_NODISCARD virtual shared<texture2d> create_texture2d(data_desc<texture2d> const & value, address_t data = {}) noexcept = 0;
...
namespace ml::gfx
{
	...
	{
	public:
		ML_NODISCARD static auto create(data_desc<texture2d> const & value, address_t data = {}) noexcept
		{
