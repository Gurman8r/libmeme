...
namespace ml::gfx
{
	...
	// base device
	class ML_RENDERER_API render_device : public non_copyable, public trackable
	{
	private:
		/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace ml::gfx
{
	...
	// base render context
	class ML_RENDERER_API render_context : public render_object<render_context>
	{
	public:
		/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace ml::gfx
{
	...
	// base vertexarray
	class ML_RENDERER_API vertexarray : public render_object<vertexarray>
	{
	public:
...
namespace ml::gfx
{
	...
	// base vertexbuffer
	class ML_RENDERER_API vertexbuffer : public render_object<vertexbuffer>
	{
	public:
...
namespace ml::gfx
{
	...
	// base indexbuffer
	class ML_RENDERER_API indexbuffer : public render_object<indexbuffer>
	{
	public:
		ML_NODISCARD static auto create(uint32_t usage, size_t count, addr_t data) noexcept
		{
...
namespace ml::gfx
{
	...
	// base texture
	class ML_RENDERER_API texture : public render_object<texture>
	{
	public:
...
namespace ml::gfx
{
	...
	// base texture2d
	class ML_RENDERER_API texture2d : public texture
	{
	public:
...
namespace ml::gfx
{
	...
	// base texturecube
	class ML_RENDERER_API texturecube : public texture
	{
	public:
...
namespace ml::gfx
{
	...
	// base framebuffer
	class ML_RENDERER_API framebuffer : public render_object<framebuffer>
	{
	public:
...
{
	// base program
	class ML_RENDERER_API program : public render_object<program>
	{
	public:
...
namespace ml::gfx
{
	...
	// base shader
	class ML_RENDERER_API shader : public render_object<shader>
	{
	public:
