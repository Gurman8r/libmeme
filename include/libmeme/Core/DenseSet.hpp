...
namespace ml::dense::detail
{
	...
	template <template <class...> class Derived,
		class Elem, class Comp, class Alloc
...
namespace ml::dense::detail
{
	...
	> struct set_base : public storage_base<Traits>
	{
		/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace ml::dense
{
	...
	> struct basic_set : public detail::set_base<
		detail::set_traits<basic_set, Elem, Comp, Alloc>
	>
	{
		/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */

		using base_type = typename detail::set_base<
			detail::set_traits<basic_set, Elem, Comp, Alloc>
		>;
